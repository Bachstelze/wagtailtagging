...
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
  <head>
    ...
    <title>MarkupSafe &#8212; wagtailtagging 1.0 Dokumentation</title>
...
<h1>MarkupSafe<a class="headerlink" href="#markupsafe" title="Link zu dieser Überschrift">¶</a></h1>
<p>Implements a unicode subclass that supports HTML strings:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">markupsafe</span> <span class="k">import</span> <span class="n">Markup</span><span class="p">,</span> <span class="n">escape</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">markupsafe</span> <span class="k">import</span> <span class="n">soft_unicode</span>
...
<h2>HTML Representations<a class="headerlink" href="#html-representations" title="Link zu dieser Überschrift">¶</a></h2>
<p>Objects can customize their HTML markup equivalent by overriding
the <cite>__html__</cite> function:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">class</span> <span class="nc">Foo</span><span class="p">(</span><span class="nb">object</span><span class="p">):</span>
...
<h2>Silent Escapes<a class="headerlink" href="#silent-escapes" title="Link zu dieser Überschrift">¶</a></h2>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">markupsafe</span> <span class="k">import</span> <span class="n">Markup</span><span class="p">,</span> <span class="n">escape_silent</span> <span class="k">as</span> <span class="n">escape</span>
...
<span class="k">class</span> <span class="nc">SilentMarkup</span><span class="p">(</span><span class="n">Markup</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">escape</span><span class="p">(</span><span class="n">cls</span><span class="p">,</span> <span class="n">s</span><span class="p">):</span>
        <span class="k">return</span> <span class="n">cls</span><span class="p">(</span><span class="n">escape</span><span class="p">(</span><span class="n">s</span><span class="p">))</span>
</pre></div>
</div>
</div>
<div class="section" id="new-style-string-formatting">
<h2>New-Style String Formatting<a class="headerlink" href="#new-style-string-formatting" title="Link zu dieser Überschrift">¶</a></h2>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">User</span><span class="p">(</span><span class="nb">object</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="nb">id</span><span class="p">,</span> <span class="n">username</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">__html_format__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">format_spec</span><span class="p">):</span>
        <span class="k">if</span> <span class="n">format_spec</span> <span class="o">==</span> <span class="s1">&#39;link&#39;</span><span class="p">:</span>
            <span class="k">return</span> <span class="n">Markup</span><span class="p">(</span><span class="s1">&#39;&lt;a href=&quot;/user/</span><span class="si">{0}</span><span class="s1">&quot;&gt;</span><span class="si">{1}</span><span class="s1">&lt;/a&gt;&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">format</span><span class="p">(</span>
    ...
    <span class="k">def</span> <span class="nf">__html__</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="k">return</span> <span class="n">Markup</span><span class="p">(</span><span class="s1">&#39;&lt;span class=user&gt;</span><span class="si">{0}</span><span class="s1">&lt;/span&gt;&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">username</span><span class="p">)</span>
</pre></div>
</div>
<p>And to format that user:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">user</span> <span class="o">=</span> <span class="n">User</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="s1">&#39;foo&#39;</span><span class="p">)</span>
...
<ul>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../../../../_sources/lib/python2.7/site-packages/MarkupSafe-0.23.dist-info/DESCRIPTION.txt"
...
<script type="text/javascript">$('#searchbox').show(0);</script>
    ...
    <div class="footer">
      ...
      |
      <a href="../../../../_sources/lib/python2.7/site-packages/MarkupSafe-0.23.dist-info/DESCRIPTION.txt"
